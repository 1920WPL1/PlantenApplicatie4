...
//endregion
    ...
    String INSERTSTANDAARD =
            "INSERT INTO plant (planttype, familie, geslacht, soort, variatie, plantdichtheid_min, plantdichtheid_max, fgsv) " +
                    "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    String INSERTTYPE =
            "INSERT INTO planttype(planttype_id, type_naam) VALUES(?, ?)";
